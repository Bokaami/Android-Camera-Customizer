package ca.yorku.eecs.mack.democamera76375;
 ...
 * (<code>DemoCamera76375Activity</code>). At this juncture, the <code>onActivityResult</code> method in the calling activity
 ...
 * <code>DemoCamera76375Activity</code>, <code>ImageListViewerActivity</code>, and <code>VideoViewerActivity</code>. The
 * fourth is the activity associated with the camera intent. Activities are launched via intents. The intent to launch
 * this demo's initial activity, <code>DemoCamera76375Activity</code>, is specified through the <code>intent-filter</code>
...
public class DemoCamera76375Activity extends Activity implements OnClickListener, OnTouchListener {
    ...
    Uri fileUri;
    ImageButton imgButton, vidButton, imgBackButton, imgForButton, vidBackButton, vidForButton, imgGalleryButton ;
    ImageView imageView;
    VideoView videoView;
    ...
    private void initialize() {
        ...
        vidButton = (ImageButton) findViewById(R.id.button2);
        imageView = (ImageView) findViewById(R.id.imageView1);
        videoView = (VideoView) findViewById(R.id.videoView1);
        imgBackButton = (ImageButton) findViewById(R.id.button1a);
        imgForButton = (ImageButton) findViewById(R.id.button1b);
        vidBackButton = (ImageButton) findViewById(R.id.button2a);
        vidForButton = (ImageButton) findViewById(R.id.button2b);
        ...
        imgGalleryButton = (ImageButton) findViewById(R.id.button);
        ...
        imgForButton.setOnClickListener(this);
        vidBackButton.setOnClickListener(this);
        vidForButton.setOnClickListener(this);
    ...
    public boolean onTouch(View v, MotionEvent me) {
        ...
        if (v == videoView && videoFilenames.length > 0) {
    ...
    public void onClick(View v) {
        if (v == imgButton) // launch camera intent (image mode)
        {
            // create Intent to take a picture and return control to the calling application
            Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
